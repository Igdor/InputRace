...
version = tk.Label(window, text="v0.01", fg='black', font=("Helvetica", 9), anchor="e", bg=main_color)
version.pack()
...
label_distance_text = tk.Label(frame_distance, text="Distance covered:", font=("Helvetica", 11), bg=main_color, anchor="n")
...
label_last_boost_text = tk.Label(frame_last_boost, text="Boost:", font=("Helvetica", 11), bg=main_color, anchor="n")
...
label_reaction = tk.Label(frame_input, text="Let`s go!", font=("Helvetica", 14), bg=main_color, anchor="n")
label_reaction.grid(row=0, column=0, columnspan=2, padx=40, pady=10)
field_input = tk.Entry(frame_input, bd=4, width=26, bg=main_color)
